...
const projects = [
  {
    ...
    description: "Terrain renderer using a terrain height map and with dynamic terrain height and light direction. Applied Phong shading model using material textures and normal maps. Added a skybox and billboard vegetation.  Implemented advanced techniques such as dynamic level of detail and animated water, ensuring accurate reflections of skybox present in the water. ",
    category: "Graphics",
